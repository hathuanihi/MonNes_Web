...
export default function DepositPage() {
  const [depositAmount, setDepositAmount] = useState("300,000 VND");
  // Fake API data
  ...
  const handleDeposit = (e: React.FormEvent) => {
    ...
    alert("Deposit submitted: " + depositAmount);
  };
      ...
      <div className="flex-grow flex items-center justify-center pt-16">
        <div className="w-full max-w-[900px] bg-white rounded-2xl shadow-lg overflow-hidden my-8">
          <div className="flex flex-col items-center justify-center h-full p-16">
            <h2 className="text-4xl font-bold text-[#FF086A] mb-10 text-center">Deposit Form</h2>
            <form onSubmit={handleDeposit} className="w-full">
              <div className="grid grid-cols-2 gap-x-8">
                ...
                <div className="py-5 text-[22px] text-gray-800 flex items-center">Deposit Amount</div>
